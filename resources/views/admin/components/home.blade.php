                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p><a href="#">Jonathan Smith</a> added new milestone <span><a
                                                            href="#" class="green">ERP</a></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </article>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p><a href="#">Anjelina Joli</a> added new album <span><a
                                                            href="#" class="blue">PARTY TIME</a></span></p>
                                                <div class="album">
                                                    <a href="#">
                                                        <img alt="" src="{{ asset('admin/img/sm-img-1.jpg') }}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{ asset('admin/img/sm-img-2.jpg') }}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{ asset('admin/img/sm-img-3.jpg') }}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{ asset('admin/img/sm-img-1.jpg') }}">
                                                    </a>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p><a href="#">Jonatha Smith</a> added new milestone <span><a
                                                            href="#" class="light-green">prank</a></span> Lorem
                ...
                <div class="col-lg-8">
                    ...
                    <section class="panel post-wrap pro-box">
                        <aside class="post-highlight terques v-align">
                            <div class="panel-body">
                                <h2>Flatlab is new model of admin dashboard <a href="javascript:;"> http://demo.com/</a> 4
                                    days ago by jonathan smith</h2>
                            </div>
                        </aside>
                        <aside>
                            <div class="post-info">
                                ...
                                <div class="follower">
                                    <div class="panel-body">
                                        ...
                                        <div class="follow-ava">
                                            <img src="{{ asset('admin/img/follower-avatar.jpg') }}" alt="">
                                        </div>
                                    </div>
                                </div>
